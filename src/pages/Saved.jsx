      ...
      <div className="container px-4 py-12 mx-auto">
        ...
        {savedArticles.length + savedVideos.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="mb-4 text-2xl font-medium text-primary-yellow">Your reading list is empty</p>
            <p className="mb-8 text-lg text-gray-300">Save interesting articles to read them later!</p>
            <Link to="/">
              <button className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium transition duration-300 ease-out border-[3px] rounded-full shadow-md border-primary-yellow text-primary-light group">
                ...
                <span className="absolute flex items-center justify-center w-full h-full transition-all duration-300 transform text-primary-light group-hover:translate-x-full ease">Browse News Articles</span>
                <span className="relative invisible">Browse News Articles</span>
              </button>
            </Link>
          </div>
        )}
